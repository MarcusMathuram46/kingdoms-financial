...
import '../styles/Enquiry.css'; // Create this CSS file for custom styles
...
function Enquiry() {
  ...
  return (
    <div id='enquiry' className="enquiry-container container">
      <h2 className="enquiry-title text-center">Get in Touch</h2>
      <p className="enquiry-description text-center">
          ...
          <form onSubmit={handleSubmit} className="enquiry-form">
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="Stocks and Loanss">Stocks and Loans</option>
